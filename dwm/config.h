...
static Key keys[] = {
  ...
  { MODKEY,                   	XK_d,          spawn,         	       {.v = rofi    } },
	...
	// Audio controls
	{ MODKEY,			XK_minus,	spawn,		SHCMD("pactl -- set-sink-volume 0 -5%; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,		XK_minus,	spawn,		SHCMD("pactl -- set-sink-volume 0 -15%; kill -44 $(pidof dwmblocks)") },
	{ MODKEY,			XK_equal,	spawn,		SHCMD("pactl -- set-sink-volume 0 +5%; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,		XK_equal,	spawn,		SHCMD("pactl -- set-sink-volume 0 +15%; kill -44 $(pidof dwmblocks)") },
